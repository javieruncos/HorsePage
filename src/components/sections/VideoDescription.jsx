...
const VideoDescription = () => {
  return (
    <div className="my-25 container px-7 mx-auto">
      <div className="my-10">
      ...
      <div className="grid grid-cols-3 gap-4 text-white">
        {/* Card 1 */}
        <div className="bg-[#3e3f43] p-4 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-102 hover:shadow-2xl">
