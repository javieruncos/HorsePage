...
const Portada = () => {
  return (
    // <div className="portada mt-20 md:mt-0 md:h-[660px] bg-black flex items-center justify-center relative md:overflow-hidden">
    //   <img
    //     src={imgPortada}
    //     alt="caballo"
    ...
    //       <motion.div
    //         className="relative "
    //         initial={{ opacity: 0, scale: 0.8 }} // empieza invisible y un poco más chico
    //         animate={{ opacity: 1, scale: 1 }} // aparece y toma su tamaño normal
    //         transition={{
    //           duration: 0.5,
    //           ease: "easeOut",
    //         }}
    //       >
    //         <div className="px-13 py-0  md:py-30  flex-1 z-10 text-center md:text-left">
    ...
    //           <div className="w-full md:w-[350px] text-white px-2 mt-20 md:mt-7 mx-auto md:mx-0 text-sm md:text-base">
    //             <p>
    ...
    //       </motion.div>
    //       <motion.div
    //         className="px-30 relative hidden md:block"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start w-full h-full relative px-4 sm:px-10 md:px-0">
          ...
          >
            <div className="px-4 sm:px-6 md:px-13 py-4 md:py-30 text-center md:text-left">
              ...
              {/* Descripción + botón */}
              <div className="w-full sm:w-[400px] md:w-[350px] text-white px-2 sm:px-0 mt-10 md:mt-7 mx-auto md:mx-0 text-sm sm:text-base">
                <p>
                  Majestuoso y equilibrado, este caballo destaca por su
                  elegancia, potencia y temperamento noble. Su conformación
                  armoniosa y su andar firme reflejan años de cuidado y
